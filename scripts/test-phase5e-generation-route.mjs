...
assert.match(synthesisRequest.instructions, /validated(?:, answer-ready)? evidence packet/i)
...
assert.match(synthesisRequest.instructions, /already decided.*answer-ready|answer-ready.*deterministic/i)
assert.doesNotMatch(synthesisRequest.instructions, /If the supplied evidence does not answer the question/i)
